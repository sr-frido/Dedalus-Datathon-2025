...
def abrir_info_output():
    ...
    resumen_text = tk.Text(ventana_info, height=1, width=60, font=("Helvetica", 10), bg="#2d2d2d", fg="#ffffff", insertbackground="#ffffff", wrap="word")
    ...
    analisis_text = tk.Text(ventana_info, height=3, width=60, font=("Helvetica", 10), bg="#2d2d2d", fg="#ffffff", insertbackground="#ffffff", wrap="word")
    ...
    observaciones_text = tk.Text(ventana_info, height=4, width=60, font=("Helvetica", 10), bg="#2d2d2d", fg="#ffffff", insertbackground="#ffffff", wrap="word")
...
pw_right.add(frame_superior_derecha, height=300)
...
input_text = scrolledtext.ScrolledText(frame_superior_derecha, width=80, height=5,
                                       font=("Segoe UI", 10), bg=bg_dark, fg=fg_text, insertbackground=fg_text, wrap="word")
input_text.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)

# Salida y análisis
frame_medio_derecha = ttk.Frame(pw_right, padding=10)
pw_right.add(frame_medio_derecha, height=550)
...
output_text = scrolledtext.ScrolledText(frame_medio_derecha, width=80, height=5,
                                        ...
                                        bg=bg_dark, fg=fg_text, insertbackground=fg_text, wrap="word")
