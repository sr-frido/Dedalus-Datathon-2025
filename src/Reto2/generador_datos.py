...
# Nuevas provincias andaluzas con sus latitudes y longitudes
nuevas_provincias = {
    "Jaén": (37.7799, -3.7794),
    "Cádiz": (36.5271, -6.2923),
    "Algeciras": (36.1408, -5.4599),
}
...
# Generar nuevos pacientes hasta completar 200
for i in range(len(original_data), 200):
    paciente_id = i + 1
